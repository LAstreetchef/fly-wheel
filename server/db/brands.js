...
export async function createBrandCampaign(brandId, data) {
  ...
  const contentPrompt = `Create an authentic post sharing your thoughts on ${name}. Be genuine and creative!`;
  await pool.query(
  ...
  console.log(`[createBrandCampaign] Mission created for campaign ${campaign.id}`);
