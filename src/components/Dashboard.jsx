...
const PRODUCTS = [
  ...
  { type: 'blog', name: 'Blog Post', price: '20', image: '/fly-wheel/squad/stella.mp4', isVideo: true, description: '500-word SEO snippet', color: 'from-yellow-500 to-orange-500' },
            ...
            {PRODUCTS.map((product) => (
              ...
              >
                <div className="bg-gray-900 rounded-xl p-4 h-full">
                  {product.isVideo ? (
                    <video src={product.image} autoPlay loop muted playsInline className="w-12 h-12 object-contain mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  ) : (
